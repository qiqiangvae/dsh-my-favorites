...
function useSettings(scope) {
  ...
  return snapshot.value ?? { sessions: [], urls: [] };
}
...
function UrlSettingsCard({ scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "mf-settings", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mf-card", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u6536\u85CF\u7F51\u5740" }),
...
var SwitcherMachine = class {
  ...
  emit() {
    this.snapshot = { open: this.open, activeIndex: this.activeIndex, items: this.items() };
    for (const fn of this.listeners) fn();
  }
  snapshot = { open: false, activeIndex: 0, items: [] };
...
function SessionSwitcherOverlay({ items, activeId, onConfirm, onCancel }) {
...
function SessionSwitcherHost() {
  ...
  return ReactDOM.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SessionSwitcherOverlay, { items: snap.items, activeId, onConfirm: (id) => {
...
function apply(ctx) {
  ...
  ctx.effect(() => {
    try {
      ...
      switcherMachine.start({ openSession: (id) => ctx.sessions.open(id), getList: () => sessionsList.getSnapshot(), subscribeList: (fn) => sessionsList.subscribe(fn), getSessions: () => scope.getSnapshot().value?.sessions ?? [], subscribeSessions: (fn) => scope.subscribe(fn) });
    } catch (e) {
  ...
  ctx.slots.inject("settings.plugins.tab", () => ctx.slots.register({ name: "settings.plugins.tab", id: "my-favorites", order: 30, label: () => "\u6536\u85CF", inject: () => ({ scope }) }, UrlSettingsCard));
}
